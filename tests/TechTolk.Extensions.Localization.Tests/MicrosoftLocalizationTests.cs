...
public class MicrosoftLocalizationTests : AbstractTechTolkTests
{
    [Fact]
    public void Using_the_microsoft_localization_string_localizer_of_t_will_return_translations_loaded_by_tech_tolk()
    {
        ...
        _services.AddTechTolkLocalizationAdapters();
    ...
    [Fact]
    public void Using_the_microsoft_localization_string_localizer_factory_will_return_translations_loaded_by_tech_tolk()
    {
        _services.AddLocalization();
    ...
    [Fact]
    public void Adding_adapters_before_calling_microsofts_AddLocalization_will_throw_an_exception()
    {
        var act = () => _services.AddTechTolkLocalizationAdapters();
